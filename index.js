...
const getConnString = async (credentials) => {
    ...
    // see https://github.com/Azure/azure-sdk-for-node/blob/master/lib/services/serviceBusManagement2/lib/operations/queues.js#L2771
    const result = await azureArmSb.queues.listKeys(
